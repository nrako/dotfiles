...
if exists('g:vscode')
  nmap <silent> <leader>rn <Cmd>call VSCodeNotifyVisual('editor.action.rename', 1)<CR>
  nmap <silent> <leader>gy <Cmd>call VSCodeNotifyVisual('editor.action.goToTypeDefinition', 1)<CR>
else
  " === COC ====
  "
  ...
  " Use K/gh to show documentation in preview window.
